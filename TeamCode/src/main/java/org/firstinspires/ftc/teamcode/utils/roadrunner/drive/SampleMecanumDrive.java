...
public class SampleMecanumDrive extends MecanumDrive {
	public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(2.5d, 0, 0);
	public static PIDCoefficients HEADING_PID = new PIDCoefficients(2.5d, 0, 0);

	public static double LATERAL_MULTIPLIER = 1.22d;
